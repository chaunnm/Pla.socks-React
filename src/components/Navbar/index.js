    ...
    <div className="nav">
      <div className="wrapper">
        ...
        >
          ...
          <mark>
            ❤️❤️❤️ This is a line to make it less blank, please don't be too
            concerned about it but take care of the useful things below. Thank
            you!!!{" "}
          </mark>{" "}
          - <i> From all members of group 4 With Love </i>
        </marquee>
        <div className="items">
          <div className="item">
